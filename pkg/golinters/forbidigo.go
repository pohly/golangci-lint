...
func NewForbidigo(settings *config.ForbidigoSettings) *goanalysis.Linter {
	...
	// Without AnalyzeTypes, LoadModeSyntax is enough. But we cannot make
	// this depend on the settings and have mirror the mode chosen in
	// GetAllSupportedLinterConfigs, therefore we have to use
	// LoadModeTypesInfo in all cases.
